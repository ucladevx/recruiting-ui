			...
			<div className="cards">
				<div className="card card-wide profile-card">
					...
					<form className="app-form">
						...
						<SelectInput required name="tshirt" title="T-Shirt Size" originalValue={this.props.profile.tshirt} options={Config.profile.tshirtSizes} onChange={this.props.setValue} />
